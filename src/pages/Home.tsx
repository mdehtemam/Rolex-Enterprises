    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-8">
        <div className="bg-amber-50 rounded-xl shadow-sm border border-amber-200 p-6">
          ...
          <p className="text-sm text-slate-700 mb-4">Enter a SKU to instantly view the product price.</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 px-4 py-2 border border-amber-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent font-mono bg-white"
            />
            <div className="sm:w-32 flex items-center justify-start sm:justify-end text-sm text-amber-700">
          ...
          {(skuError || skuResult) && (
            <div className="mt-4">
              {skuError && (
                <div className="p-3 bg-white border border-amber-200 rounded-lg text-amber-900 text-sm">
                  {skuError}
                </div>
              )}

              {skuResult && (
                <div className="mt-3 bg-white border border-amber-200 rounded-lg overflow-hidden">
